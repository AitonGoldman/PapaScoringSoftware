...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_player__ = __webpack_require__(736);
...
var AddPlayerPageModule = (function () {
    ...
    AddPlayerPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__add_player__["a" /* AddPlayerPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_take_pic_take_pic__ = __webpack_require__(361);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var AddPlayerPage = (function (_super) {
    ...
    function AddPlayerPage() {
        ...
        _this.selectedPlayer = { player_full_name: "" };
        _this.loading = false;
        _this.ifpaLookup = false;
        _this.existingPlayerFound = true;
        _this.displayNewPlayerForm = false;
        return _this;
    }
    ...
    AddPlayerPage.prototype.generateAddEventPlayersProcessor = function () {
        ...
        return function (result) {
            ...
            var successSummary = new __WEBPACK_IMPORTED_MODULE_2__classes_success_summary__["a" /* SuccessSummary */](success_title_string, success_line_one_string, success_line_two_string);
            ...
            var successButtonTickets = new __WEBPACK_IMPORTED_MODULE_3__classes_SuccessButton__["a" /* SuccessButton */]('Purchase Tickets', 'TicketPurchasePage', _this.buildNavParams({ player_id_for_event: result.data[0].events[0].player_id_for_event }));
    ...
    AddPlayerPage.prototype.takePicture = function () {
        var _this = this;
        var profileModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_4__components_take_pic_take_pic__["a" /* TakePicComponent */], { userId: 8675309 });
        ...
        return function (searchResults) {
            ...
            if (searchResults.typeOfSearch == "list" && searchResults.resultList.length == 0) {
                if (_this.searchbar.keyword.length > 2) {
                    ...
                    console.log(_this.searchbar.keyword);
    ...
    AddPlayerPage.prototype.ionViewWillLoad = function () {
        ...
        this.autoCompleteProvider.initializeAutoComplete("player-full-name", null, this.generateLoadingFunction());
        this.events.subscribe('autocomplete:done', function (autocompleteInfo, time) {
            ...
            if (autocompleteInfo.state == 'DONE' && autocompleteInfo.data.data.length == 0) {
                ...
                _this.displayNewPlayerForm = true;
            }
        });
