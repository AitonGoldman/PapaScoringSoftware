angular.module('app.scorekeeping.undo.remove_player',['app.scorekeeping.undo.remove_player.confirm',
    /*REPLACEMECHILD*/]);
angular.module('app.scorekeeping.undo.remove_player').controller(
    'app.scorekeeping.undo.remove_player',[
