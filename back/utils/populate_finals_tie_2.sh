...
curl -X PUT -H "Content-Type: application/json" -b /tmp/cookie http://0.0.0.0:8000/elizabeth/finals/finals_match_game_player_result/3/score/4
...
curl -X PUT -H "Content-Type: application/json" -b /tmp/cookie http://0.0.0.0:8000/elizabeth/finals/finals_match_game_player_result/8/score/2
...
curl -X PUT -H "Content-Type: application/json" -b /tmp/cookie http://0.0.0.0:8000/elizabeth/finals/finals_match_game_player_result/9/score/1
