angular.module('app.scorekeeping.undo.insert_into_queue.player_select',['app.scorekeeping.undo.insert_into_queue.player_select.process',
    /*REPLACEMECHILD*/]);
angular.module('app.scorekeeping.undo.insert_into_queue.player_select').controller(
    'app.scorekeeping.undo.insert_into_queue.player_select',[
