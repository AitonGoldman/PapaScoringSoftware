...
export URL="http://0.0.0.0:8000/elizabeth/division/1/division_machine/$1/team/$2"
sleep .1
curl -X PUT -b /tmp/cookie -s -o /tmp/test_out_add_team_to_machine_$1.out -w "\npeekaboo - $1 - %{time_total}" -H "Content-Type: application/json" $URL > /tmp/time_team_add_to_machine_$1.out 2>&1 &
