...
class RouteTokenTest(PssUnitTestBase):
    ...
    def test_get_number_of_unused_tickets_for_player(self):
        ...
        returned_token_count = token.get_number_of_unused_tickets_for_player(mock_player,self.mock_app,tournament=mock_tournament)        
    ...
    def test_get_number_of_unused_tickets_for_player_in_meta_tournament(self):
        ...
        mock_tokens.filter_by().count.return_value=1
        self.mock_tables.Tokens.query.filter_by.return_value = mock_tokens
        returned_token_count = token.get_number_of_unused_tickets_for_player(mock_player,self.mock_app,meta_tournament=mock_meta_tournament)        
        self.assertEquals(returned_token_count,1)
