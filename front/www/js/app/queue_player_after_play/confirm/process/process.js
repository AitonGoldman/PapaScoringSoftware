...
angular.module('app.queue_player_after_play.confirm.process').controller(
	...
	$scope.division_machine_to_queue_on_name=$state.params.division_machine_to_queue_on_name;        
        ...
        add_to_queue_promise = TimeoutResources.AddToQueue(undefined,{site:$scope.site},{division_machine_id:$scope.division_machine_to_queue_on_id,player_id:$scope.player_id});
        Modals.loading();
