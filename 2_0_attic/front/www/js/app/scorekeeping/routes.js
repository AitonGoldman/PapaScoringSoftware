angular.module('TDApp').config(['$stateProvider', '$urlRouterProvider',function($stateProvider, $urlRouterProvider) {    
    $stateProvider.state('app.scorekeeping', 
 	 ...
 	 views: {
        ...
        { 
         cache: false,
 	 url: '/player_select/division_machine_id/:division_machine_id/division_machine_name/:division_machine_name/player_name/:player_name/player_id/:player_id/previous_player_id/:previous_player_id/previous_player_name/:previous_player_name/team_tournament/:team_tournament',
 	 views: {
 	     'menuContent@app': {
 	 ...
 	 views: {
       ...
       }).state('app.scorekeeping.undo.undo_bump_player.confirm', 
        { 
         cache: false,
 	 ...
 	 views: {
 	     'menuContent@app': {
 	       ...
 	       controller: 'app.scorekeeping.undo.undo_bump_player.confirm'
 	     }
 	   }
       }).state('app.scorekeeping.undo.undo_bump_player.confirm.process', 
        { 
         cache: false,
 	 ...
 	 views: {
 	     'menuContent@app': {
 	       ...
 	       controller: 'app.scorekeeping.undo.undo_bump_player.confirm.process'
 	     }
 	   }, params: {
             process_step:{}
