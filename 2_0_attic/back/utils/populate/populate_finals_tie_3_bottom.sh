...
curl -X PUT -H "Content-Type: application/json" -b /tmp/cookie -d "[[9,false],[16,true],[17,false]]" http://0.0.0.0:8000/elizabeth/finals/division_final_match/1/tie_breaker_results
