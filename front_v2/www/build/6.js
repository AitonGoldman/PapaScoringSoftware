...
var TournamentMachinesPageModule = (function () {
    ...
    TournamentMachinesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__tournament_machines__["a" /* TournamentMachinesPage */]),
...
var TournamentMachinesPage = (function (_super) {
    ...
    TournamentMachinesPage.prototype.generateGetAllTournamentMachinesProcessor = function () {
        ...
        return function (result) {
            ...
            _this.autoCompleteProvider.initializeAutoComplete('machine_name', result.data.machines_list);
    ...
    TournamentMachinesPage.prototype.generateGetAllMachinesProcessor = function () {
        ...
        return function (result) {
            ...
            _this.autoCompleteProvider.initializeAutoComplete('machine_name', result.data);
        };
    };
    ...
    TournamentMachinesPage.prototype.generateCreateWizardProcessor = function () {
        ...
        return function (result) {
            ...
            var successSummary = new SuccessSummary(successTitle, null, null);
            var successButton = new SuccessButton('Go Home', _this.getHomePageString(), _this.buildNavParams({}));
