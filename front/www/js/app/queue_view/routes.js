angular.module('TDApp').config(['$stateProvider', '$urlRouterProvider',function($stateProvider, $urlRouterProvider) {    
    $stateProvider.state('app.queue_view', 
 	 ...
 	 views: {
        ...
        { 
         cache: false,
 	 url: '/queue/division_id/:division_id/game_1/:game_1/game_2/:game_2/game_3/:game_3/game_4/:game_4/game_5/:game_5/game_6/:game_6/game_7/:game_7/game_8/:game_8/game_9/:game_9/game_10/:game_10/game_11/:game_11/game_12/:game_12/columns/:columns/num_players_to_show/:num_players_to_show',
 	 views: {
 	     'menuContent@app': {
