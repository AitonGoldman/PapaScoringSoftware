...
create_pss_event_user_permissions = Permission(RoleNeed(roles_constants.TOURNAMENT_DIRECTOR),RoleNeed(roles_constants.PSS_ADMIN),RoleNeed(roles_constants.PSS_USER))
