...
## Frameworks/Libraries used by the backend
* AngularJs 1.x : Javascript framework that the frontend uses : https://docs.angularjs.org/tutorial AND https://docs.angularjs.org/guide
...
Note the following conventions : The python files (and the classes defined within) in `back/td_types` have a captitolized first letter.
